...
def ordered_2metal_stack(substrate, metal1, metal2, layers):
...
#--------------------------------------------------------------
# Simpler form of ordered_2metal_stack that does not specify
# a 2nd metal layer, and so produces a stack with only one
# metal layer.
#--------------------------------------------------------------

def ordered_stack(substrate, metal, layers):
    return ordered_2metal_stack(substrate, metal, None, layers)
